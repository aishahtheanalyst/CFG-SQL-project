...
CREATE TABLE `savoury` (
  ...
  `main_ingredient` varchar(20) DEFAULT NULL
...
INSERT INTO `savoury` VALUES (1,'meat_pie',1.25,'pork'),(1,'meat pie',1.25,'pork'),(2,'sausage roll',1,NULL),(3,'pasty',2.45,'beef');
...
INSERT INTO `sweet` VALUES (1,'doughnut',0.5),(1,'doughnut',0.5),(1,'doughnut',0.5),(1,'doughnut',0.5),(2,'croissant',0.75),(3,'painauchocolat',0.55),(4,'cinnamon twirl',0.45),(5,'cannoli',0.88),(6,'apple tart',1.12);
...
-- Dump completed on 2022-06-22 11:38:56
